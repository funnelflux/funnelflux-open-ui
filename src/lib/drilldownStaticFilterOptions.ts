...
/** ISO 3166-1 alpha-2 codes (from content/countries.php). */
export const DRILLDOWN_COUNTRY_FILTER_OPTIONS: SelectOption[] = [
  ...
  { value: 'CC', label: 'Keeling Cocos Islands (CC)' },
  ...
  { value: 'FK', label: 'Malvinas Falkland Islands (FK)' },
  ...
  { value: 'KP', label: 'Democratic People\'s Republic of Korea (KP)' },
  { value: 'KR', label: 'Republic of Korea (KR)' },
  ...
  { value: 'FM', label: 'Federated States of Micronesia (FM)' },
  { value: 'MD', label: 'Republic of Moldova (MD)' },
...
export const DRILLDOWN_CONTINENT_FILTER_OPTIONS: SelectOption[] = [
...
export const DRILLDOWN_DEVICE_TYPE_FILTER_OPTIONS: SelectOption[] = [
...
export const DRILLDOWN_CONNECTION_TYPE_FILTER_OPTIONS: SelectOption[] = [
...
/** Curated suggestions; free-text entry remains available in the filter popover. */
export const DRILLDOWN_DEVICE_OS_SUGGESTION_OPTIONS: SelectOption[] = [
...
export const DRILLDOWN_DEVICE_BROWSER_SUGGESTION_OPTIONS: SelectOption[] = [
...
const STATIC_FILTER_OPTIONS_BY_GROUP_BY: Record<string, SelectOption[]> = {
  'Location: Country': DRILLDOWN_COUNTRY_FILTER_OPTIONS,
  'Location: Continent': DRILLDOWN_CONTINENT_FILTER_OPTIONS,
  'Device: Type': DRILLDOWN_DEVICE_TYPE_FILTER_OPTIONS,
  'Connection: Type': DRILLDOWN_CONNECTION_TYPE_FILTER_OPTIONS,
  'Device: OS': DRILLDOWN_DEVICE_OS_SUGGESTION_OPTIONS,
  'Device: Browser': DRILLDOWN_DEVICE_BROWSER_SUGGESTION_OPTIONS,
}

export function getDrilldownStaticFilterOptions(groupBy: string): SelectOption[] | null {
  if (!groupBy.trim()) return null
  return STATIC_FILTER_OPTIONS_BY_GROUP_BY[groupBy] ?? null
}
